...
namespace LearningApp.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<LearningApp.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<LearningApp.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(LearningApp.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(LearningApp.Server.Models.ApplicationUser user)
        {
            try
            {
