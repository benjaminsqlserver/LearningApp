...
{
    public partial class AddStudentExercise
    {
        [Inject]
        ...
        {
            studentExercise = new LearningApp.Server.Models.SvgDB.StudentExercise();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SvgDBService.CreateStudentExercise(studentExercise);
