...
{
    public partial class EditStudentExerciseResult
    {
        [Inject]
        ...
        {
            studentExerciseResult = await SvgDBService.GetStudentExerciseResultByResultId(resultId:ResultID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await SvgDBService.UpdateStudentExerciseResult(resultId:ResultID, studentExerciseResult);
