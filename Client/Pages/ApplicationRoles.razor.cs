...
namespace LearningApp.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<LearningApp.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(LearningApp.Server.Models.ApplicationRole role)
        {
            try
            {
